...
import { DEPLOYED_ADDRESSES, CHAINS, POOL_CONFIG } from './addresses'
import { MOCK_ORACLE_ABI, POOL_MANAGER_ABI, AEGIS_HOOK_ABI } from './abis'
...
export function PriceProvider({ children }: { children: React.ReactNode }) {
    ...
    const [l2Price, setL2Price] = useState<number>(2000)
